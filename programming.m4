XGH_TIT(`Programming')
XGH_HUL(`2',`Quick links',`dnl
XGH_LIAL(`https://man.archlinux.org/man/m4.1p.en')
XGH_LIAL(`https://wiki.archlinux.org/title/Pacman/Rosetta')
')
XGH_H(`2',`Next steps')
...
dnl#and use as a build-time filter, e.g. remove noentry from Ragel 67
