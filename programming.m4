...
XHG_LI(`beautifier/formatter for Ragel')
...
XGH_LIA(`https://docs.oracle.com/javase/1.5.0/docs/guide/language/enums.html',`https://docs.oracle.com/javase/1.5.0/docs/guide/language/enums.html')
...
XGH_LIA(`https://pubs.opengroup.org/onlinepubs/9799919799/utilities/make.html',`')
